      ...
      >
          ...
          content={
            <>
              ...
              <p>
                ...
                <strong>Sustentabilidade</strong> e <strong>Reciclagem</strong>,
                ambos de grande importância nos dias atuais.
              </p>
            </>
          }
        />
        ...
        <Card
          ...
          content={
            <>
              <p>
                Atualmente estamos em uma fase de melhorias continuas,
                constamente estamos reformando o projeto de acordo com a
                aquisição das peças necessárias para continuarmos, o projeto já
                passou por diversas versões até aqui e pretendemos continuar!
              </p>
              <p>
                Atualmente estamos em uma fase de melhorias continuas,
                constamente estamos reformando o projeto de acordo com a
          ...
          content={
            <>
              <p className="text-left w-full">
                As tampinhas adquiridas em nosso projeto são trocadas em
                cadeiras de rodas!
              </p>
              <p>
                Então além de ajudarmos o meio ambiente com a propagação do
                nosso projeto também temos impacto em causas sociais!
              </p>
            </>
          }
        />
