...
export default function Placar({img, number, description, imgSize, loading}: PlacarProps) {
 return (
    <Link href={"/historico"} className="px-6 py-8 flex justify-center items-center max-sm:flex-wrap md:flex-row md:justify-around bg-blue-600 rounded-md hover:scale-105 border-4 border-blue-600 hover:border-blue-700/70 duration-150">
      <Image
        src={img}
