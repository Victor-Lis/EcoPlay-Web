...
export default function Banner() {
  const { total, loading } = useContext(CapContext);
  return (
    <>
      <div id="banner-up" className="mb-.5/"/>
      <div id="banner" className="mb-2"/>
      <div className="w-10/12 md:w-5/12 gap-y-5 flex flex-col justify-center items-center mb-40" id="banner-box">
        <Placar img={TampinhaImg} number={total} description="Tampinhas Coletadas" loading={loading} />
